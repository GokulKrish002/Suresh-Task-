            ...
            <div class="row">
                <div class="col-lg-8 col-md-12 table-area">
                    ...
                    <div class="d-flex">
                        ...
                        <asp:Button ID="Button1" runat="server"  class="btn btn-primary" Text="Button" OnClick="Button1_Click1" />
                    </div>
                </div>
                ...
                <div class="col-lg-3 col-md-12 m-5 ml-5 ">
                        ...
                        <div id="lightRed" class="lights rounded-circle bg-secondary"></div>
                        <br>
                        <div id="lightYellow" class="lights rounded-circle bg-secondary"></div>
                        <br>
                        <div id="lightGreen" class="lights rounded-circle bg-secondary"></div>
                        <br>
                </div>
            </div>
        </form>
